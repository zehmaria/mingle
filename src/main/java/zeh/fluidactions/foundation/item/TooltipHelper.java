package zeh.fluidactions.foundation.item;
...
import zeh.fluidactions.foundation.utility.Components;
import zeh.fluidactions.foundation.utility.Couple;
...
public class TooltipHelper {
    ...
    public record Palette(Style primary, Style highlight) {
        public static final Palette STANDARD = new Palette(styleFromColor(0xC9974C), styleFromColor(0xF1DD79));
