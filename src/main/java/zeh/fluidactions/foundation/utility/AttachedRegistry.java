package zeh.fluidactions.foundation.utility;
    ...
    public void register(ResourceLocation id, V value) {
        if (!unwrapped) {
            ...
            if (object != null) {
                ...
                FluidActions.LOGGER.warn("Could not get object for id '" + id + "' in AttachedRegistry after unwrapping!");
            }
        }
    }
    ...
    public void register(K object, V value) {
        if (unwrapped) {
            ...
            if (id != null) {
                ...
                FluidActions.LOGGER.warn("Could not get id of object '" + object + "' in AttachedRegistry before unwrapping!");
            }
        }
    }
    ...
    protected void unwrap() {
        deferredRegistrations.forEach((id, func) -> {
            ...
            if (object != null) {
                ...
                FluidActions.LOGGER.warn("Could not get object for id '" + id + "' in AttachedRegistry during unwrapping!");
            }
        });
